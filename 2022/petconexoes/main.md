...
header: IV Jornada de Ciência, Tecnologia e Meio Ambiente
# footer: Leon Silva
marp: true
---
...
![bg right:30%](images/logo-pet3.jpg)


## O Ecossistema Python para Computação Científica
### Leon Silva
...
---
#### Corrida espacial (NASA)
<!-- header: Um exemplo da história-->
<!-- <b>Image Credits - Fig.2 - 4K Mountains Wallpaper</b>|
![bg 40% ](https://www.blogs.unicamp.br/cienciapelosolhosdelas/wp-content/uploads/sites/53/2020/04/katherine_johnson_dorothy_vaughan_e_mary_jackson-1-e1586898751289.jpg.) -->

<p align = "center">
<img src = https://www.blogs.unicamp.br/cienciapelosolhosdelas/wp-content/uploads/sites/53/2020/04/katherine_johnson_dorothy_vaughan_e_mary_jackson-1-e1586898751289.jpg." width="800" 
     height="400">
</p>
<p align = "center">
...
---
<!-- header: Um exemplo atual -->
#### Pixar Studios
![bg 50% right: 80% ](https://64.media.tumblr.com/3cdbba9c4123ab50a65cbf3e9ffd1bcb/tumblr_nylhce2j1T1uv18swo3_400.jpg)
![bg 50%](images/pixar.png)
...
![bg 60% right:20%](https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Python.svg/2048px-Python.svg.png)
 #### Python
- **Prós**
   - Várias bibliotecas para computação científica
...
```
---
![bg 80% right:25%](https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Pandas_logo.svg/300px-Pandas_logo.svg.png)
#### O que é o pandas?
- Processamento de dados
   - Algoritmos:
     - ler e escreve dados tabulares
     - Calcula estatística dos dados
     - Trabalha com séries temporais com facilidade
     - Manipula e filtra informações
...
#### pandas
 ```python
 df = pd.DataFrame({
    'Cálculo': [70.5, 80.7, 50.4, 70.5, 80.9],
    'Física': [40.24, 50.9, 70.6, 80.1, 50.9],
    'Geo. Analítica': [30, 50.5, 70.8, 90.88, 30],
    'Turma': ['Eng. Ambiental', 'Eng. Civil', 'Física', 
...
---
#### Output
![bg 70% ](images/dataframe.png)

---
### Pandas
Resumo estatístico
```Python
df[['Cálculo', 'Física']].describe()
```
![bg 50% right:50% ](images/statisticas.png)
...
![bg 80% ](https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Scikit_learn_logo_small.svg/1200px-Scikit_learn_logo_small.svg.png)
 ![bg 80% ](https://qiskit.org/textbook/assets/images/logo_qiskit_purple_new.svg)
